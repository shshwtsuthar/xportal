-- 20260129000001_update_approval_function.sql
-- Purpose: Update approve_application_atomic function to handle split street number and name.
...
BEGIN
  ...
  -- Updated to use split street number and name
