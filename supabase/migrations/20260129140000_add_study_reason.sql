-- Add study_reason_id to applications
ALTER TABLE applications ADD COLUMN IF NOT EXISTS study_reason_id text;

-- Add study_reason_id to student_avetmiss
ALTER TABLE student_avetmiss ADD COLUMN IF NOT EXISTS study_reason_id text;

-- Re-create atomic function including study_reason_id
...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO students (
      ...
      preferred_name, email, date_of_birth, work_phone, mobile_phone, home_phone,
      ...
      v_app.work_phone, v_app.mobile_phone, v_app.home_phone, v_app.alternative_email, 'ACTIVE',
  ...
  INSERT INTO student_addresses (
    student_id, rto_id, type, building_name, unit_details, number_name, po_box,
    suburb, state, postcode, country, is_primary
  ) VALUES (
    v_student.id, v_app.rto_id, 'street', v_app.street_building_name, 
    v_app.street_unit_details, v_app.street_number_name, v_app.street_po_box,
  ...
  IF NOT COALESCE(v_app.postal_is_same_as_street, false) THEN
    INSERT INTO student_addresses (
      ...
      v_app.postal_unit_details, v_app.postal_number_name, v_app.postal_po_box,
  ...
  -- Updated to include study_reason_id
  INSERT INTO student_avetmiss (
    ...
    survey_contact_status, vsn, usi, study_reason_id
  ) VALUES (
    ...
    v_app.vsn, v_app.usi, v_app.study_reason_id
  )
