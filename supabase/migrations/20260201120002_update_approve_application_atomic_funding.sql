-- Add AVETMISS NAT00120: approve_application_atomic copies funding_source_national (part 3/3)
...
BEGIN
  ...
  -- 11) Copy learning plan subjects to enrollment_subjects (with funding_source_national)
