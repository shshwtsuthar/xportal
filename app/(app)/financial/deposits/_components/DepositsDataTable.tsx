...
export type DepositsDataTableRef = { getRows: () => RowType[] };
...
export const DepositsDataTable = forwardRef<DepositsDataTableRef, Props>(
  function DepositsDataTable({ filters }: Props, ref) {
    ...
    const allColumns: ColumnDef[] = getDepositsColumns();
    ...
    if (isError)
      return (
        <p className="text-destructive text-sm">Failed to load deposits.</p>
      );
        ...
        <div className="border-b p-3">
          <div className="relative">
            ...
            <Input
              ...
              aria-label="Search deposits table"
            />
          </div>
        </div>
        <Table>
