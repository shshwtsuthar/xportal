          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-xs">
                Select program plans to include in this timetable. Timetables
                are now generalized and can contain classes for multiple groups.
              </p>
              {programId ? (
                <div className="space-y-2">
                  {programPlans.length === 0 ? (
                    <Alert>
                      ...
                      <AlertDescription>
                        No program plans available for this program. Please
                        create program plans for this program first.
                      </AlertDescription>
                    </Alert>
                  ) : (
                ...
                <p className="text-muted-foreground text-sm">
                  Select a program to see available program plans
                </p>
              )}
            </div>
